  ...
  return (
    ...
    >
      ...
      >
        ...
        <hr/>
        <p class='card-text'>Neighborhood: {listingData.neighborhood}</p>
        <p class='card-text'>Area: {listingData.area}</p>
        <p class='card-text'>Latitude: {listingData.latitude}</p>
        <p class='card-text'>Longitude: {listingData.longitude}</p>
        <p class='card-text'>General Price: {listingData.general_price}</p>
